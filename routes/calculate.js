...
var calculateController = require('../controllers/calculateController');

router.get('/', calculateController.index);
router.post('/', calculateController.validate('calculate_post'), calculateController.calculate_post);
